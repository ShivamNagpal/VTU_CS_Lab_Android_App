...
object StaticMethods {
  ...
  fun logNetworkResultError(logTag: String, url: String, code: Int, message: String?) {
    Log.e(
        logTag,
        "Call to $url resulted in non-success response. Status Code: $code. Message: $message")
  }

  fun logNetworkResultException(logTag: String, url: String, throwable: Throwable) {
    Log.e(logTag, "Call to $url failed with exception: ${throwable.javaClass.name}", throwable)
  }
